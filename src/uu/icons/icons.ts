...
// Bootstrap Icons (check) — a selected single-choice option.
...
// Bootstrap Icons (check-square) — a selected option in `multiple` mode. No
// unchecked counterpart: an unselected row shows nothing.
